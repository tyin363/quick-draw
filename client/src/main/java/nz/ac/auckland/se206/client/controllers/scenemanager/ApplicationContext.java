...
public class ApplicationContext extends InstanceFactory {
  ...
  /**
   * Starts the application with the given stage and starting view. It will initialise the
   * {@link ApplicationContext} and the {@link SceneManager} and automatically create the view.
   *
