...
import nz.ac.auckland.se206.client.components.icons.ClockIcon;
import nz.ac.auckland.se206.client.components.icons.FlameIcon;
import nz.ac.auckland.se206.client.users.User;

public class UserProfile extends VBox {

  /**
   * Creates a nz.ac.auckland.se206.client.components.profile.UserProfile component from the given
   * user. It consists of a profile picture, username and a summary of their statistics.
   *
