...
import nz.ac.auckland.se206.client.controllers.HeaderController;

public class Helpers {

  /**
   * Given the header referenced by {@link HeaderController}, it will iterate through the known
   * hierarchy to find the back button.
   *
